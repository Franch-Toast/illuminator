...
_BPF_INCLUDES = "-Isrc/ebpf_common/include -isystem /usr/include"

_BPF_HDRS = [
    "//src/ebpf_common:include/vmlinux.h",
    "//src/ebpf_common:include/common.bpf.h",
    "//src/ebpf_common:include/event_types.h",
]
